...
// ========================================
// System Showcase Carousel (Multi-Carousel Support)
// ========================================
document.addEventListener("DOMContentLoaded", () => {
  ...
  function initCarousel(carouselElement) {
    ...
    const activeTitle = carouselElement.querySelector(".section-sub-title");
    const activeSubtitle = carouselElement.querySelector(".section-subtitle[id^='subtitle']");
  ...
  // Encontra todos os carrosséis na página e inicializa cada um
...
window.addEventListener("scroll", () => {
  ...
  if (currentScroll > 100) {
    navbarNav.style.boxShadow = "0 4px 20px rgba(0, 0, 0, 0.5)";
  } else {
